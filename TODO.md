...
- [x] TODO-FEAT: Finished Date (should be auto completed on change of reading status to Read)
- [x] TODO-FEAT: Pop-up dialog box when book has been completed, congratulating you on the completion and asking for a star rating and personal review

## Auth

- [x] TODO-FEAT: Add password reset option
